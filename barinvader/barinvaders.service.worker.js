...
/** @type {string} */
const CACHE_VERSION = '1773821935|83801412';
/** @type {string} */
const CACHE_PREFIX = 'BarInvadersV2-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'barinvaders.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["barinvaders.html","barinvaders.js","barinvaders.offline.html","barinvaders.icon.png","barinvaders.apple-touch-icon.png","barinvaders.audio.worklet.js","barinvaders.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["barinvaders.wasm","barinvaders.pck"];
