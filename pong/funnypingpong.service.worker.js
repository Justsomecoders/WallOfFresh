...
/** @type {string} */
const CACHE_VERSION = '1773821336|1073077343';
/** @type {string} */
const CACHE_PREFIX = 'funnypingpong-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'funnypingpong.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["funnypingpong.html","funnypingpong.js","funnypingpong.offline.html","funnypingpong.icon.png","funnypingpong.apple-touch-icon.png","funnypingpong.audio.worklet.js","funnypingpong.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["funnypingpong.wasm","funnypingpong.pck"];
